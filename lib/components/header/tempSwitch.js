...
var TempSwitch = function TempSwitch() {
  var _React$useState = React.useState('C'),
  ...
  var switchTemp = function switchTemp(temperature) {
    if (temperature === 'C') {
      setTemp('F');
    } else {
      setTemp('C');
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onClick: function onClick() {
      return switchTemp(temp);
    }
  }, /*#__PURE__*/React.createElement(_AcUnit.default, {
    color: "primary",
    sx: {
      fontSize: 60
    },
